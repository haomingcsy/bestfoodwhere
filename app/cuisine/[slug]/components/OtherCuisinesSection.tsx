...
import type { OtherCuisine } from "../data";

interface OtherCuisinesSectionProps {
  cuisines: OtherCuisine[];
}

export function OtherCuisinesSection({ cuisines }: OtherCuisinesSectionProps) {
  return (
    <section className="mb-5 rounded-xl bg-white px-5 py-8">
      <div className="mb-5 text-center">
        <h2 className="font-heading text-[26px] font-bold text-bfw-orange">
          Other Cuisines You Might Like
        </h2>
        <p className="mt-2 font-body text-base text-[#666]">
          Explore more food options in Singapore
        </p>
      </div>
