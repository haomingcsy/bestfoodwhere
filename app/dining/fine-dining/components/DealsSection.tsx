...
import { FINE_DINING_DEALS } from "../data";
import type { DiningDeal } from "@/types/dining";

const TERMS = [
  "Advance reservation required, subject to availability",
  "Valid for dinner service only",
  "Not valid on public holidays or special occasions",
        ...
        <div className="max-h-[70vh] overflow-y-auto p-6">
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 font-body text-sm text-[#555]">
              1. Make a reservation mentioning this exclusive offer
            </p>
            <p className="mt-1 font-body text-sm text-[#555]">
              2. Provide the promo code:{" "}
