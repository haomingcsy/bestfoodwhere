...
If `.claude/skills/product-marketing-context/context.md` exists (or `.claude/skills/product-marketing-context/context.md` in older setups), read it before asking questions. Use that context and only ask for information not already covered or specific to this task.
